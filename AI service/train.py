...
# #         max_depth=4, 
# #         learning_rate=0.05, 
# #         scale_pos_weight=odnos_klasa,#0.2, 
# #         random_state=42, 
# #         eval_metric='logloss'
# #     )
...
# #     criterion = GlaucomaProgressionLoss()
# #     # Osiguravamo da unutrašnji pos_weight tenzor pređe na GPU/CPU
...
#     # Pomoćne promenljive za čuvanje čistih, odvojenih predikcija iz najbolje epohe
#     best_gru_preds = None
#     best_xgb_preds = None
...
#         # Bazični miks za praćenje epoha (0.4/0.6)
#         ensemble_preds = (0.4 * all_gru_preds) + (0.6 * all_xgb_preds)
#         epoch_val_loss = log_loss(all_targets, ensemble_preds, labels=[0, 1])
...
#             # KORAK 1: Čuvamo odvojene predikcije iz ove (najbolje) epohe za kasniju pretragu
...
#     # =========================================================================
#     # KORAK 1 INTEGRACIJA: Pokretanje pretrage za optimalne težine ansambla
#     # =========================================================================
...
#         # Prolazimo kroz raspodele težina od 0.0 do 1.0 sa korakom 0.05
...
#     # =========================================================================
#     # KORAK 2 INTEGRACIJA: Uklonjena problematična augmentacija šumom
#     # =========================================================================
...
#     # Računanje realnog odnosa klasa za balansiranje (na originalnim train podacima)
#     broj_negativnih = np.sum(y_train_orig == 0)
#     broj_pozitivnih = np.sum(y_train_orig == 1)
#     odnos_klasa = broj_negativnih / broj_pozitivnih
...
def train_single_fold(fold, model, train_loader, val_loader, criterion, optimizer, epochs, device, checkpoint_dir, global_best_val_loss, xgb_model):
    ...
    for epoch in range(1, epochs + 1):
        ...
        # IZMENA: DataLoader sada vraća i batch_lengths
        for batch_x, batch_y, batch_lengths in train_loader:
            batch_x, batch_y = batch_x.to(device), batch_y.to(device)
            
            optimizer.zero_grad()
            # IZMENA: Prosleđujemo i batch_lengths u model
        ...
        with torch.no_grad():
            # IZMENA: DataLoader na validaciji takođe vraća batch_lengths
            for batch_x, batch_y, batch_lengths in val_loader:
                batch_x_dev = batch_x.to(device)
                # IZMENA: Prosleđujemo batch_lengths
